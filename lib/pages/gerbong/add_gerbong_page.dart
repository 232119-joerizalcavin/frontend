...
class AddGerbongPage extends StatefulWidget {
  const AddGerbongPage({super.key});

  @override
  State<AddGerbongPage> createState() => _AddGerbongPageState();
}

class _AddGerbongPageState extends State<AddGerbongPage> {
  ...
  void initState() {
    super.initState();
    _kodeGerbongController = TextEditingController();
    _jenisGerbongController = TextEditingController();
    _kapasitasController = TextEditingController();
    _nomorSeriController = TextEditingController();
        ...
        listener: (context, state) {
          if (state is GerbongLoaded) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('✅ Gerbong berhasil ditambahkan!'),
                          ...
                          onPressed: state is GerbongLoading
                              ...
                              : () {
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    print('📤 Submitting gerbong data: $gerbongData');
                                    context.read<GerbongBloc>().add(AddGerbong(gerbongData));
                                  }
                                },
